...
*/
let x = [1,7,9,45,['str','alex','moh','the','fox','over','lazy','dog']];
...
3- Favorite Movie (4)
*/
let favFood = ["salad","sandwich","bread","fish","shrimp"];
let favSport = ["football","Tennis","Golf"];
let favMovie = ["see","dark","sciene"];
...
*/
function indexOfArray(arra,index){
    return arra[index];
}
...
**try more cases by your self
*/
function shorterInArray(number){
    let min = number[0];
    for(let i = 0; i < number.length; i++){
        if(number[i].length < min.length){
            min = arr[i];
        }
    }
    return min;
...
**try more cases by your self
*/
function evenIndexOddLength(arra){
    let newArra = [];
...
**try more cases by your self
*/
function powerElementIndex(arra){
    let newArra = [];
    for(let i = 0; i < arra.length; i++){
        newArra.push(arra[i]**i);
    }
    return newArra;
}
...
**try more cases by your self
*/
function evenNumberEvenIndex(arra){
    let newArra = [];
    for(let i = 0; i < arra.length; i++){
        if(arra[i] % 2 === 0){
            newArra.push(arra[i]);
