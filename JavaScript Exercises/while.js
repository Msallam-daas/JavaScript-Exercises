...
Ex: multiOf(6,2,3); => 48
*/
function multiOf(firstNumber, secondNumber, thirdNumber) {
...
*/
function muti2(firstNumber, secondNumber) {
    let result = 1;
    while (firstNumber <= secondNumber) {
        result *= firstNumber;
        first++;
...
*/
function multiplication2(firstNumber, secondNumber) {
    let result = 0;
    while (firstNumber > 0) {
        result += secondNumber;
        firstNumber--;
...
mod2(8,4) => 0
*/
function mod2(firstNumber, secondNumber) {
    let result = 0;
    while (firstNumber > 0) {
        result += secondNumber;
        firstNumber--;
